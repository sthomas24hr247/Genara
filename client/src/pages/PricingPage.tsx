      ...
      <section className="bg-gradient-to-b from-teal-100 via-cyan-50 to-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-4">
            Start for free, then enjoy<br />$1/month for 3 months
          </h1>
                  ...
                  <div className="mb-4">
                    ...
                    {!plan.isEnterprise && (
                      <p className="text-gray-500 text-sm mt-1">
                        {billingCycle === "monthly" ? "billed monthly" : "billed once yearly"}
                      </p>
                    )}
                    {plan.isEnterprise && (
                      <p className="text-gray-500 text-sm mt-1">on a 3-year term</p>
                    )}
                  </div>
                  <div className="mb-6">
                    ...
                    <ul className="space-y-2">
                      {plan.features.map((feature) => (
                        <li key={feature} className="flex items-start gap-2 text-sm text-gray-600">
                          <Check className="w-4 h-4 text-gray-400 mt-0.5 flex-shrink-0" />{feature}
                        </li>
                      ))}
                    </ul>
                  </div>
...
EOFcat > client/src/pages/PricingPage.tsx << 'EOF'
import { useState } from "react";
import { Check, ShoppingCart, Store, Share2, BarChart3, AppWindow } from "lucide-react";
